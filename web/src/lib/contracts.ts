...
export const expense = z.object({
  ...
  split_mode: z.enum(["preserve", "equal"]).default("preserve"),
});
...
export type TripEditInput = z.infer<typeof tripEdit>;
export type ExpenseInput = z.infer<typeof expense>;
export type ActivityInput = z.infer<typeof activity>;
export type BookingInput = z.infer<typeof booking>;
export type ShoppingInput = z.infer<typeof shopping>;
export type HomeCurrency = z.infer<typeof home>;
